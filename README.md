...
```
Кому необходимо работать с Enable в стиле циско - не забудте добавить сюда же:

post-auth {
    # Добавляем атрибуты для всех успешно аутентифицированных сессий
    update reply {
        Service-Type = Administrative-User
        Cisco-AVPair = "shell:priv-lvl=15"
    }

    # Далее идет остальной ваш конфиг (например, sql, ldap, exec и т.д.)
    # ...
}
